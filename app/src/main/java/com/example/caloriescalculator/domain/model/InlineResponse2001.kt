...
data class InlineResponse2001 (
    ...
    val missedIngredients: kotlin.Array<RecipesFindByIngredientsMissedIngredients>,
    @Json(name = "title")
    val title: kotlin.String,
    @Json(name = "unusedIngredients")
    val unusedIngredients: kotlin.Array<kotlin.Any>,
    @Json(name = "usedIngredientCount")
    val usedIngredientCount: java.math.BigDecimal,
    @Json(name = "usedIngredients")
    val usedIngredients: kotlin.Array<RecipesFindByIngredientsMissedIngredients>,
