...
class IngredientsApi(basePath: kotlin.String = "https://api.spoonacular.com") : ApiClient(basePath) {
    ...
    */
    ...
    fun autocompleteIngredientSearch(query: kotlin.String?, number: kotlin.Int?, metaInformation: kotlin.Boolean?, intolerances: kotlin.String?) : Observable<kotlin.Array<InlineResponse20024>> {
        ...
        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as Observable<kotlin.Array<InlineResponse20024>>
